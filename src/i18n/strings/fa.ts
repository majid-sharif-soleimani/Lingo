...
const fa: UIStrings = {
  ...
  // Plan tab
  tabPlan: 'برنامه',
  generatePlan: 'تولید برنامه یادگیری',
  ...
  planGenerating: 'ChatGPT در حال ساختن برنامه شما است…',
  planStale: 'پروفایل دانش‌آموز تغییر کرده است. برنامه را دوباره تولید کنید.',
  planRegenerate: 'تولید مجدد برنامه',
  planRegenerateConfirm: 'Regenerating will permanently reset all plan progress. Continue?',
  planKeepCurrent: 'Keep Current Plan',
  planProgress: 'پیشرفت',
  planDay: 'روز',
  planStartThisLesson: 'شروع این درس',
  planNoActivePlan: 'No learning plan yet.',
  planParseFailed: 'Could not parse the learning plan. Please try again.',
  planFollowPlan: 'پیروی از برنامه یادگیری',
  planChooseManually: 'Choose session type manually',
  planNextDay: 'درس بعدی',
  // Frequency labels
  freqDaily: 'هر روز',
  freqWeekdays: 'روزهای کاری (دوشنبه تا جمعه)',
  freqAlternate: 'یک روز در میان',
  freqWeekly: 'یک بار در هفته',
  // Practice material generator
  practiceTitle: 'مواد تمرینی',
  practiceType: 'Material Type',
  practiceTopic: 'Topic',
  practiceTopicPlaceholder: 'e.g. Present Perfect, travel vocabulary…',
  practiceLevel: 'Level',
  practiceGenerate: 'تولید',
  practiceGenerating: 'در حال تولید…',
  practiceDownloadPdf: 'دانلود PDF',
  practiceBack: '← بازگشت',
